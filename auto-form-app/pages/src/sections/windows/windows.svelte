  ...
  <section id="windows-section" class="section js-section u-category-windows">
      ...
      <div class="section-wrapper">
        <h1>
          <svg class="section-icon">
            <use xlink:href="../assets/img/icons.svg#icon-windows" />
          </svg>
          Create and Manage Windows
        </h1>
        <h3>
          The <code>BrowserWindow</code> module in Electron allows you to create
        ...
        <p>
          Open the <a href="http://electron.atom.io/docs/api/browser-window"
    ...
    <div class="demo">
      <div class="demo-wrapper">
        <button
          id="new-window-demo-toggle"
          class="js-container-target demo-toggle-button"
          >Create a new window
          <div class="demo-meta u-avoid-clicks">
            Supports: Win, macOS, Linux <span class="demo-meta-divider">|</span>
            Process: Main
          </div>
        </button>
        <div class="demo-box">
          ...
          <p>
            The <code>BrowserWindow</code> module gives you the ability to
            create new windows in your app. This main process module can be used
            from the renderer process with the <code>remote</code> module, as is
            shown in this demo.
          </p>

          <p>
            There are a lot of options when creating a new window. A few are in
            this demo, but visit the <a
              href="http://electron.atom.io/docs/api/browser-window"
              >documentation<span class="u-visible-to-screen-reader"
                >(opens in new window)</span
              ></a
            > for the full list.
          </p>
          ...
          <pre><code
              data-path="renderer-process/windows/create-window.js"
            /></pre>

          <div class="demo-protip">
            <h2>ProTip</h2>
            <strong
              >Use an invisible browser window to run background tasks.</strong
            >
            <p>
              You can set a new browser window to not be shown (be invisible) in
              ...
              You do this by setting the <code>show</code> property to
              <code>false</code> when defining the new window.
            </p>
            <pre>
<code class="language-js"
  ...
  width: 400, height: 225, show: false
      ...
      <div class="demo-wrapper">
        ...
        <div class="demo-box">
          <div class="demo-controls">
            ...
            <span class="demo-response" id="manage-window-reply" />
          </div>
          <p>
            In this demo we create a new window and listen for <code>move</code>
            and <code>resize</code> events on it. Click the demo button, change the
          ...
          <p>
            ...
            listen to for window changes. Visit the <a
              href="http://electron.atom.io/docs/api/browser-window"
              >documentation<span class="u-visible-to-screen-reader"
                >(opens in new window)</span
              ></a
          ...
          <h5>Renderer Process</h5>
          <pre><code
              data-path="renderer-process/windows/manage-window.js"
            /></pre>
        </div>
      </div>
    </div>
    ...
    <div class="demo">
      <div class="demo-wrapper">
        <button
          id="using-window-events-demo-toggle"
          class="js-container-target demo-toggle-button"
        ...
        <div class="demo-box">
          <div class="demo-controls">
            ...
            <button class="demo-button disappear" id="focus-on-modal-window"
              >Focus on Demo</button
            >
          </div>
          <p>
            In this demo, we create a new window and listen for <code>blur</code
            >
            ...
            the
            <i>Focus on Demo</i> button to switch focus to the modal window again.
          </p>
          <h5>Renderer Process</h5>
          <pre><code
              data-path="renderer-process/windows/using-window-events.js"
            /></pre>
        </div>
      </div>
    </div>
    ...
    <div class="demo">
      <div class="demo-wrapper">
        ...
        <div class="demo-box">
          ...
          <h5>Renderer Process</h5>
          <pre><code
              data-path="renderer-process/windows/frameless-window.js"
            /></pre>

          <p>
            Windows can have a transparent background, too. By setting the <code
              >transparent</code
            >
            option to
            <code>true</code>, you can also make your frameless window
            transparent:
          </p>
          <pre>
<code class="language-js"
  ...
  frame: false
          ...
          <p>
            For more details, see the <a
              href="http://electron.atom.io/docs/api/frameless-window/"
              >Frameless Window</a
            >
            documentation.
          </p>
