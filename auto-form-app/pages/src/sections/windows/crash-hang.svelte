  ...
  >
      ...
      <div class="section-wrapper">
        <h1>
          <svg class="section-icon"
            ><use xlink:href="../assets/img/icons.svg#icon-windows" /></svg
          >
          Handling Window Crashes and Hangs
        </h1>
        <h3>
          The <code>BrowserWindow</code> module will emit events when the renderer
    ...
    <div class="demo">
      <div class="demo-wrapper">
        <button
          id="new-window-crashes-demo-toggle"
        ...
        <div class="demo-box">
          ...
          <p>
            In this demo we create a new window (via the <code>remote</code>
            module) and provide a link that will force a crash using
            <code>process.crash()</code>.
          </p>
          <p>
            The window is listening for the crash event and when the event
            occurs it prompts the user with two options: reload or close.
          </p>

          <h5>Renderer Process</h5>
          <pre><code
              data-path="renderer-process/windows/process-crash.js"
            /></pre>
        </div>
      </div>
    </div>
    ...
    <div class="demo">
      <div class="demo-wrapper">
        <button
          id="new-window-hangs-demo-toggle"
          class="js-container-target demo-toggle-button"
        ...
        <div class="demo-box">
          ...
          <p>
            The window is listening for the process to become officially
          ...
          <h5>Renderer Process</h5>
          <pre><code
              data-path="renderer-process/windows/process-hang.js"
            /></pre>
          ...
          <div class="demo-protip">
            ...
            <p>
              A third option in the case of a process that is hanging is to wait
              and see if the problem resolves, allowing the process to become
              responsive again. To do this, use the <code>BrowserWindow</code> event
              'responsive' as shown below.
            </p>
            <pre><code class="language-js"
                >win.on('responsive', function ())</code
              ></pre>
          </div>
        </div>
      </div>
